...
def generate_test_vectors(sim, model_inputs, output_dir, batch_index, test_vector_layers):
    ...
    for vector_type in ['fp', 'qt']:
        ...
        with ctx_managers:
            ...
            outputs = {}
            outputs['logits'] = model_outputs[0]
            outputs['past_key_values'] = model_outputs[1]
